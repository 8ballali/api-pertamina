...
(function (d) {
    ...
    d.extend(m.prototype, {
        ...
        _fnConstruct: function (a) {
            ...
            if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0")) alert("FixedColumns " + m.VERSION + " required DataTables 1.8.0 or later. Please upgrade your DataTables installation");
                ...
                d(this.s.dt.nTableWrapper).on("mousedown.DTFC", function (a) {
                    0 === a.button && (e = !0, d(r).one("mouseup",
                        function () {
                            e = !1
                        }))
                });
                d(this.dom.scroller).on("mouseover.DTFC touchstart.DTFC", function () {
                    ...
                    if ("main" === c || "key" === c)
                        if (0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop = b.dom.scroller.scrollTop), 0 < b.s.iRightColumns) b.dom.grid.right.liner.scrollTop = b.dom.scroller.scrollTop
                });
                ...
                0 < b.s.iRightColumns && (d(b.dom.grid.right.liner).on("mouseover.DTFC touchstart.DTFC",
                    ...
                    if (c === "right") {
                        ...
                        if (b.s.iLeftColumns > 0) b.dom.grid.left.liner.scrollTop = b.dom.grid.right.liner.scrollTop
                    }
                }).on(f, function (a) {
                    c = "right";
                    b.dom.scroller.scrollLeft = b.dom.scroller.scrollLeft - (a.type === "wheel" ? -a.originalEvent.deltaX : a.originalEvent.wheelDeltaX)
                ...
                h.on("draw.dt.DTFC", function () {
                    ...
                    a.namespace === "dt" && b._fnDraw(false)
                }).on("position.dts.dt.DTFC",
                    function (a, c) {
                        b.dom.grid.left.body && d(b.dom.grid.left.body).find("table").eq(0).css("top", c);
                        b.dom.grid.right.body && d(b.dom.grid.right.body).find("table").eq(0).css("top", c)
        ...
        _fnCopyLayout: function (a, b, c) {
            for (var e = [], f = [], g = [], h = 0, i = a.length; h < i; h++) {
                ...
                for (var l = 0, o = this.s.iTableColumns; l <
                    o; l++)
                    if (-1 !== d.inArray(l, b)) {
                        var q = d.inArray(a[h][l].cell, g); - 1 === q ? (q = d(a[h][l].cell).clone(c, !1)[0], f.push(q), g.push(a[h][l].cell), j.push({
                            cell: q,
                            unique: a[h][l].unique
                        })) : j.push({
                            cell: f[q],
        ...
        _fnClone: function (a, b, c, e) {
            ...
            if (e) {
                ...
                n = this._fnCopyLayout(k.aoHeader, c,
                    !0);
                j = d(">thead", a.header);
                j.empty();
                g = 0;
            ...
            if (0 < k.aiDisplay.length) {
                h = d(">thead>tr",
                    a.body)[0];
                for (q = 0; q < c.length; q++) l = c[q], o = d(k.aoColumns[l].nTh).clone(!0)[0], o.innerHTML = "", j = o.style, j.paddingTop = "0", j.paddingBottom = "0", j.borderTopWidth = "0", j.borderBottomWidth = "0", j.height = 0, j.width = f.s.aiInnerWidths[l] + "px", h.appendChild(o);
            ...
            k.oScroller !== t && (h = k.oScroller.dom.force, b.forcer ? b.forcer.style.height =
                h.style.height : (b.forcer = h.cloneNode(!0), b.liner.appendChild(b.forcer)));
        ...
        _fnEqualiseHeights: function (a, b, c) {
            if (!("none" == this.s.sHeightMatch && "thead" !== a && "tfoot" !== a)) {
                ...
                a.outerHeight();
                a.height();
                for (var g = this._fnGetTrNodes(g), b = this._fnGetTrNodes(c), h = [], c = 0, a = b.length; c < a; c++) e =
                    g[c].offsetHeight, f = b[c].offsetHeight, e = f > e ? f : e, "semiauto" == this.s.sHeightMatch && (g[c]._DTTC_iHeight = e), h.push(e);
                c = 0;
    ...
    s.Api.register("fixedColumns().cellIndex()", function (a) {
        ...
        if (a.parents(".DTFC_Cloned").length) {
            var b = a.parent().index(),
                ...
                a = a.parents(".DTFC_LeftWrapper").length ? a.index() : this.columns().flatten().length - this.context[0]._oFixedColumns.s.iRightColumns +
                a.index();
            return {
                row: b,
    ...
    s.Api.registerPlural("cells().fixedNodes()", "cell().fixedNode()", function () {
